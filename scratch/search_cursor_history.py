...
cursor_history = os.path.join(appdata, "Cursor", "User", "History")

print("Cursor History Path:", cursor_history)
if os.path.exists(cursor_history):
    entries_files = glob.glob(os.path.join(cursor_history, "**", "entries.json"), recursive=True)
    ...
    print("Cursor history path does not exist.")
